...
// Mini modal elements (view-only for title click)
...
function initSyncStatus() {
  // jika sudah ada di DOM, reuse saja
  if (syncStatusEl && document.getElementById("syncStatus")) return;
...
if (miniCloseBtn) {
  miniCloseBtn.addEventListener("click", closeTitleModal);
}

// Edit & delete dari mini modal tetap pakai mode feed / editor utama
if (miniEditBtn) {
...
calendarGrid.addEventListener("click", async (e) => {
  ...
  // init status sinkronisasi ketika modal dibuka
  initSyncStatus();
...
postsContainer.addEventListener("click", async (e) => {
  ...
  // Open mini modal on title click
  if (titleEl) {
